...
void drawImgui() {
  ...
  if (drawing::SHOW_SETTINGS_WINDOW) {
    ...
    ImGui::SliderFloat("thickness##BTSP approx", &drawing::THICKNESS[(unsigned int) ProblemType::BTSP_approx], 0.0f,
                       30.0f, "%.1f");
    ...
    ImGui::SliderFloat("thickness##BTSP exact", &drawing::THICKNESS[(unsigned int) ProblemType::BTSP_exact], 0.0f,
                       20.0f, "%.1f");
    ...
    ImGui::SliderFloat("thickness##BTSPP exact", &drawing::THICKNESS[(unsigned int) ProblemType::BTSPP_exact], 0.0f,
                       20.0f, "%.1f");
